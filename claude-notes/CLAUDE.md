...
- **Observability** (e.g. Honeycomb, Datadog) — Query traces and service dependency data
...
Teams can reference repositories from any organisation within your GitHub Enterprise. The `github_repos` field in team configs accepts any `org/repo` format.
